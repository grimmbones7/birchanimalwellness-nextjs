        ...
        <div className="bg-gray-100 p-8 rounded-lg shadow-md">
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="md:w-1/2">
              ...
              <p className="mb-4">
                After the first few times I posted pictures from Kaia and I's hikes on the trails, I had people surprised they were so close by! So I decided to hike them all and write reviews so you can find the one that works best for you. <p> This includes location, length, maps, bodies of water, elevation changes, safety, quality, and tree coverage among others.</p>
